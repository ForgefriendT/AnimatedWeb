...
function renderModal(root) {
    ...
    const getBookedSlots = (date) => {
        const stored = localStorage.getItem('kaylee_bookings');
    ...
    const saveBooking = (data) => {
        ...
        localStorage.setItem('kaylee_bookings', JSON.stringify(allBookings));
    };
    ...
    if (step === 3) {
        return `
            ...
            <div class="step-options">
                ...
                <button class="step-btn" data-value="Kaylee">Kaylee (Senior)</button>
